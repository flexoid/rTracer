...
int main()
{
    ...
    Sphere* sph2 = new Sphere(Vector3::Null(), 1.0, ColorRGB(150, 40, 15), mat1);
    //Sphere* sph3 = new Sphere(Vector3(-6.0, 2.0, 3.0), 4.0, ColorRGB(250, 90, 40), mat3);

    Light* light = new Light(Vector3(-2.0, 10.0, 7.0), 3.0);
    Camera* camera = new Camera(Vector3(5.0, 5.0, 5.0), Vector3::Null(), 1, 1);
    ...
    Screen* screen = new Screen(camera, scene, 640, 480);
